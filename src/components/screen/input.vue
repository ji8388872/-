<template>
  <div class="block">
    <el-row :gutter="20">
      ...
      <el-col :span="12">
        <el-cascader @change="changeMonth(monthValue)" :options="monthOpt" v-model="monthValue" :show-all-levels="false"
          clearable placeholder="选择月"></el-cascader>
      </el-col>
    </el-row>
  </div>
</template>
...
export default {
  ...
  created() {
    ...
    this.SET_YEARTIME(this.yearValue)
    this.SET_MONTHTIME(this.monthValue[0])
  },
  watch: {
