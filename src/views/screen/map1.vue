<template>
  <div class="main">
    ...
    <div class="tab-content" v-for="(content, index) in contents" :key="index" :class="{ active: activeTab === index, hidden: !contentVisible }">
      <div class="left">
      ...
      <div class="right">
        ...
        <a href="#" class="iconfont icon-xiayibu"></a>
        <div :class="['chart', 'chart' + (index + 1)]" v-show="activeTab === index"></div>
      </div>
    </div>
  </div>
</template>
