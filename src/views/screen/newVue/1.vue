<template>
  <div id='container' class="recommendPage">
    <div class="swiper-container">
      <div class="swiper-wrapper">
        <div class="swiper-slide" v-for="(item, index) in tmList" :key="index">
          <div class="box">
            <div class="qes-num"> {{ index + 1 }}/{{ tmList.length }}</div>
    ...
    <div class="btn-container">
      <el-button @click="prevto" :disabled="swiper.activeIndex === 0">上一题</el-button>
      <el-button @click="nextto" :disabled="swiper.activeIndex === tmList.length - 1">下一题</el-button>
    </div>
  </div>
</template>
<script>
export default {
  ...
  methods: {
    ...
    nextto() {
      ...
      if (thisindex < this.tmList.length - 1) {
