...
export default {
  ...
  methods: {
    initChart() {
      ...
      const chartElement = document.querySelector("#chart03");
      if (chartElement) {
        ...
        series: [
          {
            ...
            tooltip: {
              valueFormatter: function (value) {
                return value + " mm/条"; // 格式化提示框中显示的值，单位为kg
              },
            },
            ...
            data: [
              82.2, 48.7, 58.8, 70.7, 75.6, // 数据系列的具体值
            ],
              ...
              data: [
                {
                  ...
                  label: {
                    ...
                    formatter: "标准值上限：{c} mm/条", // 格式化标记线标签文本
                    color: "#fff", // 标记线标签文本颜色
                  },
                  lineStyle: {
                    color: "red", // 标记线颜色
                ...
                },
                {
                  ...
                  label: {
                    ...
                    align: 'right', // 标签文字对齐到右边
                    verticalAlign: 'bottom', // 标签垂直对齐到线的上方
                    formatter: "标准值下限：{c} mm/条", // 格式化标记线标签文本
                    color: "#fff", // 标记线标签文本颜色
                  },
                  lineStyle: {
                    color: "red", // 标记线颜色
