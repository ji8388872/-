      ...
      const option = {
        ...
        series: [

          {
            ...
            data: [95, 96, 96, 96, 93, 97, 95, 94, 95, 96, 97, 94, 97, 96, 96, 94, 95, 99, 96, 93, 90, 94, 99, 93, 90, 98, 92, 92, 95, 91],
          },
          {
            name: '原料含水率',
            type: 'bar',
            ...
            data: [93, 94, 95, 97, 96, 91, 90, 96, 97, 96, 94, 95, 93, 96, 98, 95, 92, 94, 95, 93, 99, 96, 92, 96, 90, 97, 96, 99, 94, 92],
          },
      ...
      const option = {
        ...
        series: [

          {
            ...
            data: [95, 96, 96, 95, 96, 97, 94, 97, 96, 96, 94, 95, 99, 96, 93, 90, 94, 99, 93, 90, 98, 92, 92, 95, 91],
          },
          {
            name: '原料含水率',
            type: 'bar',
            ...
            data: [93, 94, 95, 97, 96, 91, 90, 96, 97, 96, 94, 95, 93, 96, 98, 95, 92, 94, 95, 93, 99, 96, 99, 94, 92],
          },
      ...
      const option = {
        ...
        series: [

          {
            ...
            data: [97, 94, 97, 96, 96, 94, 95, 99, 96, 93, 90, 94, 99, 93, 90, 98, 92, 92, 95, 91],
          },
          {
            name: '原料含水率',
            type: 'bar',
            ...
            data: [93, 94, 95, 96, 94, 95, 93, 96, 98, 95, 92, 94, 95, 93, 99, 96, 99, 94, 92],
          },
