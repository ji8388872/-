        ...
        series: [
          {
            ...
            data: [
              ...
              18.8, 6.0, 2.3, 2.6, 5.9, 9.0, 26.4, 28.7, 70.7, 75.6, 82.2, 48.7,
              18.8, 6.0, 2.3, 4.4, 4.5, 4.6, 4.7,
            ],
          },
          {
            name: "环境温度",
      ...
      this.chart.setOption({
        ...
        series: [
          ...
          },
          {
            ...
            data: [17, 84, 95, 2, 44, 70, 58, 39, 99, 76, 36, 22],
          },
          {
            name: "物料温度(平均值)",
            type: "line",
      ...
      this.chart.setOption({
        ...
        series: [
...

          {
            ...
            data: [80, 11, 69, 4, 26, 51, 89, 62, 95, 73],
          },
          {
            name: "物料温度(最小值)",
            type: "bar",
            ...
            data: [95, 2, 44, 70, 58, 39, 99, 76, 36, 22],
          },
          {
            name: "物料温度(平均值)",
            type: "line",
            ...
            data: [97, 97, 39, 23, 61, 13, 58, 85, 79, 16],
          },
        ],
      });
    },
      ...
      const option = {
        ...
        series: [
          ...
          },
          {
            ...
            data: [
              48.7, 18.8, 6.0, 2.3, 28.7, 70.7, 75.6, 82.2, 48.7, 18.8, 6.0,
              2.3, 70.7, 75.6, 82.2,
            ],
          },
        ],
      ...
      const option = {
        ...
        series: [
          ...
          },
          {
            ...
            data: [
              48.7, 18.8, 75.6, 82.2, 48.7, 18.8, 6.0, 2.3, 70.7, 75.6, 82.2,
            ],
          },
        ],
      };
